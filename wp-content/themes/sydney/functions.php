...
//addons from kwork man

require get_template_directory() . '/kwork_addons/functions.php';
require get_template_directory() . '/kwork_addons/payment.php';
//youtube
require get_template_directory() . '/kwork_addons/youtube/youtube.php';
//js admin for youtube 
add_action('admin_enqueue_scripts', function () {
	wp_enqueue_script('youtube-valid', get_template_directory_uri() . '/kwork_addons/youtube/js/script.js', array('jquery'),  $in_footer = true);
	wp_enqueue_style('admin-hide-input', get_template_directory_uri() . '/kwork_addons/youtube/admin.css');
}, 99999999);
