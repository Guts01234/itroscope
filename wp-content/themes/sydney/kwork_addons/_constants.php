...
//id формы создания уроков для компании
define('COMPANY_CREATE_LESSON_FORM_ID', 624);

//id формы создания подарков
define('USER_CREATE_GIFT_FORM_ID', 680);

//id формы создания времени
define('USER_CREATE_TIME_FORM_ID', 692);
