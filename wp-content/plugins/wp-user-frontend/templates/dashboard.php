<div class="wpuf-dashboard-container">
    ...
    <h2 class="page-head">
        <span class="colour"><?php printf( esc_attr( __( "Созданные уроки", 'wp-user-frontend' ) )); ?></span>
    </h2>
    ...
    <?php if ( wpuf_get_option( 'show_post_count', 'wpuf_dashboard', 'on' ) == 'on' ) { ?>
        <?php if ( !empty( $post_type_obj ) ) { ?>
            <div class="post_count">
                ...
                printf(
                    wp_kses_post( __( 'Количество созданных уроков: <span>%d</span>', 'wp-user-frontend' ) ),
